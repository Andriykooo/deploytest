    ...
    <div className="affiliates">
      <div className="affiliatesBanner">
        <div className="customerWelcome">
          <p className="customerWelcomeTitle">New Customer Welcome Offer:</p>
          <div className="customerWelcomeGet">
            <span>GET</span>
            <div>
              <span className="goldGet">£25</span>
              <p>Free <br /> Sports Bets</p>
            </div>
          </div>
          <div className="customerWelcomePlus">
            <span>Plus</span>
            <div>
              <span className="goldPlus">50 FREE</span>
      ...
      <div className="infoForCostumers">
        <p>*For NEW customers only. Requires account opening, deposit and certain qualifying bets of Evens or greater.</p>
      </div>
      <div className="affiliatesRegister">
        <form className="registerNow" onSubmit={(e) => e.preventDefault()}>
          <h2 className="registerNowTitle">Register Now</h2>
        ...
        <div className="offerWorks">
          <h2 className="offerWorksTitle">How the offer works</h2>
          <ul className="offerWorksLists">
            <li>
              ...
              <div className="listInfo">
                <h4>Deposit</h4>
                <p>Open an account from this page.
                  Make a minimum deposit of £10.</p>
              </div>
            </li>
            <li>
              <div className="listSequence">
              ...
              <div className="listInfo">
                <h4>Release your free bets</h4>
                <p>Place a minimum of 3 x £20 qualifying  bets on the first day’s betting.</p>
              </div>
            </li>
            <li>
              <div className="listSequence">
              ...
              <div className="listInfo">
                <h4>Use your free bets</h4>
                <p>Your free bets will be available 48 hours after your last qualifying bet.</p>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div className="affiliatesInfo">
        <h3 className="affiliatesInfoTitle generalTitle">SWIFTY GAMING REWARDS CLUB & WELCOME BONUS</h3>
        <div className="affiliatesInfoTerms">
          <h3 className="affiliatesInfoTitle">Terms and conditions</h3>
