      ...
      <div className="backgroundImage ">
        <div className=" loginForm d-grid justify-content-center p-4">
          ...
          <p className="codeSent codeSend2">
            ...
            start. To activate your account and deposit funds please complete
            the following: 1. Upload identity document 2. Selfie verification
            (photo time!) 3. Upload proof of address
          </p>
          <div className=" loginForm d-grid">
            ...
            {showInformation ? (
              <p className="codeSent codeSend3">
                ...
                platform. At a minimum, we are required to verify customer
                names, addresses and date of births. These checks are aimed at
                helping prevent harm on gaming platforms and to stop crime.
              </p>
            ) : (
              ""
            )}
