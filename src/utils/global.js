...
export const getTimeDifference = (date) => {
  ...
  if (hours > 0) {
    if (hours > 1) {
      usageTime.push(`${hours} hours`);
    } else {
      usageTime.push(`${hours} hour`);
    }
  }

  if (minutes > 0) {
    if (minutes > 1) {
      usageTime.push(`${minutes} minutes`);
    } else {
      usageTime.push(`${minutes} minute`);
    }
  }

  if (seconds > 0) {
    if (seconds > 1) {
      usageTime.push(`${seconds} seconds`);
    } else {
      usageTime.push(`${seconds} second`);
    }
  }
